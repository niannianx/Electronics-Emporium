  ...
  <div>
    <header class="home-header wrap" :class="{'active' : state.headerScroll}">
      ...
      <div class="header-search">
        <span class="app-name">Emporium</span>
        <i class="iconfont icon-search"></i>
        <router-link tag="span" class="search-title" to="./product-list?from=home">点击搜索</router-link>
      </div>
...
onMounted(async () => {
  ...
  //解构赋值语法
  //axios 发送请求成功后
  // 返回的响应对象通常包含 data 属性，该属性存储着后端返回的数据
  //通过解构赋值，将响应对象中的 data 属性提取出来，并赋值给变量 data。
